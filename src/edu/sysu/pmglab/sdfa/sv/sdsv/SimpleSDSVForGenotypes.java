...
/**
 * @author Wenjie Peng
 * @create 2024-09-04 06:25
 * @description
 */
public class SimpleSDSVForGenotypes extends SimpleSDSV {
    ...
    public void parseRecord(IRecord record, SDSVConversionManager conversionManager) {
        ...
        this.svGenotypes = new SVGenotypes((Bytes) record.get(3));
    ...
    public SimpleSDSVForGenotypes setSvGenotypes(SVGenotypes svGenotypes) {
        this.svGenotypes = svGenotypes;
        return this;
    }

...
//            }
//        }
//        priorCorrectionFactor = priorCorrectionFactor / (1 - priorCorrectionFactor);
//        priorCorrectionFactor = caseNum / priorCorrectionFactor / controlNum;
...
//            for (int i = 0; i < nInd; i++) {
//                debugOut.write(String.valueOf(Y[i]));
//                for (int j = 1; j < nP; j++) {
...
//        double[] expectedVs = new double[nInd];
//        double pi0 = 0.0;   //frequency of classes
//        for (int i = 0; i < nInd; i++) {
//            expectedVs[i] = coef[0];
//            for (int j = 1; j < coef.length; j++) {
//                expectedVs[i] += coef[j] * X[i][j];
//            }
//            expectedVs[i] = Math.exp(expectedVs[i]);
//            expectedVs[i] = expectedVs[i] / (1 + expectedVs[i]);
//            //https://stats.stackexchange.com/questions/1432/what-do-the-residuals-in-a-logistic-regression-mean
//            if (Y[i] == 1) {
//                expectedVs[i] = Math.sqrt(-2 * Math.log(expectedVs[i]));
//            } else if (Y[i] == 0) {
//                expectedVs[i] = -Math.sqrt(-2 * Math.log(1 - expectedVs[i]));
//            }
//        }
//        return expectedVs;
//    }
...
//        try {
//            for (int j = 1; j < nP; j++) {
//                result.append(String.format("%8.0f", (float) j));
//                result.append(" " + String.format("%10.4f", coef[j]));
//                result.append(" " + String.format("%10.4f", coef_SE[j]));
//                result.append(" " + String.format("%10.4f", coef[j] / coef_SE[j]));
//                result.append(" " + String.format("%10.4f", Probability.chiSquareComplemented(1, Math.pow(coef[j] / coef_SE[j], 2))));
//                result.append("\n");
//            }
//
//            result.append("Intercept ");
//
//            result.append(" " + String.format("%10.4f", coef[0]));
//            result.append(" " + String.format("%10.4f", coef_SE[0]));
//            result.append(" " + String.format("%10.4f", coef[0] / coef_SE[0]));
//            result.append(" " + String.format("%10.4f", Probability.chiSquareComplemented(1, Math.pow(coef[0] / coef_SE[0], 2))));
//
//            result.append("\n");
//        } catch (Exception ex) {
//            ex.printStackTrace();
...
//            result.append(" " + ((ORc > 1e10) ? "" + ORc : String.format("%12.4f", ORc)));
//
//            result.append("\n");
//        }

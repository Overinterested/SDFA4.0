...
//
//        sb.append("beta_0 = " + intercept + " SE = " + seIntercept + " p = " + Probability.chiSquareComplemented(1, intercept * intercept / seIntercept / seIntercept));
//        sb.append("\n");
//        sb.append("beta_1 = " + slope + " SE = " + seSlope + " p = " + Probability.chiSquareComplemented(1, slope * slope / seSlope / seSlope));
//        sb.append("\n");
//        sb.append("R^2                 = " + R2);
//        //seIntercept = svar * sumx2 / (n * xxbar);
//        //sb.append("std error of beta_0 = " + Math.sqrt(seIntercept));
//
//        /*
//         sb.append("SSTO = " + yybar);
//         sb.append("SSE  = " + rss);
//         sb.append("SSR  = " + ssr);
//         */
//        return sb.toString();
...
//        return "Y= " + String.format("%.3f", slope) + "X + " + String.format("%.3f", intercept) + " RSqrd=" + String.format("%.3f", getRSquared());
//    }
//
//    /**
//     * Calculate Y given X.
